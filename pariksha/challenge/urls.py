...
urlpatterns = [
    ...
    re_path(r'^contest/testpage/(?P<challenge_id>\d+)/(?P<c_id>\d+)/$',views.testpage,name='testpage'),
    re_path(r'^contest/testpage/(?P<challenge_id>\d+)/(?P<c_id>\d+)/submitted$',views.submittedpage,name='submittedpage'),
    re_path(r'^contest/testpage/(?P<challenge_id>\d+)/(?P<c_id>\d+)/completedTest$',views.completed_testpage,name='completed_testpage'),
    re_path(r'^candidate_form/testInstruction/(?P<pk>\d+)/(?P<c_id>\d+)/$', views.test_instruction, name='test_instruction'),
    re_path(r'^candidate_form/(?P<challenge_id>\d+)/$', views.candidate_form, name='candidate_form'),
   re_path(r'^contest_management/$', views.manage_contests , name='manage_contests'),
    ...
    re_path(r'^contest_Results/(?P<contest_id>\d+)/$', views.contest_results, name='contest_results'),
    re_path(r'^download_Results/(?P<contest_id>\d+)/$', views.download_result, name='download_result'),
    ...
    re_path(r'^modify/(?P<contest_id>\d+)/contest$', views.contest_edit_form, name='contest_edit_form'),
    re_path(r'^modify/(?P<question_id>\d+)/question$', views.question_edit_form, name='question_edit_form'),
